...
from tests.test_app.sa.orm.models import Base, SAField, User
...
class BaseTestCase(AioHTTPTestCase):
    ...
    async def setUpAsync(self) -> None:
        await drop_tables(Base.metadata, DB_URL)
        await create_tables(Base.metadata, DB_URL)
